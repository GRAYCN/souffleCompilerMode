...
class Sf_TransitiveClosure : public SouffleProgram {
private:
...
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"name","path"},{"operation","output"},{"output-dir","./output/TransitiveClosure/"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"auxArity\": 0, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"auxArity\": 0, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","x\ty"},{"fact-dir","./input/TransitiveClosure/"},{"name","edge"},{"operation","input"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"auxArity\": 0, \"params\": [\"x\", \"y\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"auxArity\": 0, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
SignalHandler::instance()->setMsg(R"_(path(x,y) :- 
   edge(x,y).
in file /home/w/CLionProjects/souffle/input/TransitiveClosure/TransitiveClosure.dl [7:1-7:26])_");
if(!(rel_3_edge->empty())) {
[&](){
...
SignalHandler::instance()->setMsg(R"_(path(x,y) :- 
   path(x,z),
   edge(z,y).
in file /home/w/CLionProjects/souffle/input/TransitiveClosure/TransitiveClosure.dl [8:1-8:38])_");
...
SouffleProgram *newInstance_TransitiveClosure(){return new Sf_TransitiveClosure;}
SymbolTable *getST_TransitiveClosure(SouffleProgram *p){return &reinterpret_cast<Sf_TransitiveClosure*>(p)->symTable;}

#ifdef __EMBEDDED_SOUFFLE__
class factory_Sf_TransitiveClosure: public souffle::ProgramFactory {
SouffleProgram *newInstance() {
return new Sf_TransitiveClosure();
};
public:
factory_Sf_TransitiveClosure() : ProgramFactory("TransitiveClosure"){}
};
extern "C" {
factory_Sf_TransitiveClosure __factory_Sf_TransitiveClosure_instance;
}
}
#else
}
...
{
try{
souffle::CmdOptions opt(R"(./input/TransitiveClosure/TransitiveClosure.dl)",
R"()",
R"()",
false,
R"()",
...
souffle::Sf_TransitiveClosure obj;
#if defined(_OPENMP) 
